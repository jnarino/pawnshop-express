...
const sqlCreate = loadSql('commands', 'session_create');
const sqlFindByRefreshHash = loadSql('queries', 'session_find_by_refresh_hash');
const sqlUpdate = loadSql('commands', 'session_update');
const sqlRevoke = loadSql('commands', 'session_revoke');
